...
open class FlexibleTextFieldView: UIView, UITextViewDelegate {
    ...
    override init(frame: CGRect) {
        ...
        let resizeImage = UIImage(named: "resize", in: Bundle(for: self.classForCoder), compatibleWith: nil)
        resizeBtn.setImage(resizeImage, for: UIControlState())
        ...
        let xImage = UIImage(named: "cancel", in: Bundle(for: self.classForCoder), compatibleWith: nil)
        closeBtn.setImage(xImage, for: UIControlState())
    ...
    func resizeView(_ gesture:UIPanGestureRecognizer) {
        let newCoord = gesture.location(in: self.superview!)
    ...
    func removeSelfFromSuperview(_ sender:AnyObject){
